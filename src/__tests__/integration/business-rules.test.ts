...
describe('Business Critical Rules', () => {
    ...
    describe('Registration Rules', () => {
        it('should create TAILOR users with PENDING status', async () => {
            ...
            vi.mocked(prisma.user.create).mockResolvedValue({ id: '1', role: 'TAILOR', status: 'PENDING' } as any);
        ...
        it('should create CLIENT users with ACTIVE status', async () => {
            ...
            vi.mocked(prisma.user.create).mockResolvedValue({ id: '2', role: 'CLIENT', status: 'ACTIVE' } as any);
    ...
    describe('Permission Rules (requirePermission)', () => {
        ...
        it('should allow OWNER (Tailor) unrestricted access to their org', async () => {
            ...
            vi.mocked(prisma.organization.findFirst).mockResolvedValue({ id: ORG_ID, ownerId: 'user-tailor' } as any);
