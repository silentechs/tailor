    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Share this link via your favorite platform</DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-6 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <Input id="link" defaultValue={url} readOnly className="h-10 text-sm bg-slate-50" />
              <Button
                type="button"
                size="icon"
                onClick={copyToClipboard}
                className={cn(
                  'h-10 w-10 shrink-0 transiton-all',
