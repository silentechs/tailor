        ...
        <div className="space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    <h1 className="text-4xl font-black font-heading text-slate-900 tracking-tight">Tailor <span className="text-primary italic">Moderation</span></h1>
                    <p className="text-slate-500 font-medium">Approve and verify fashion entrepreneurs on the platform.</p>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-slate-50 hover:bg-transparent px-8">
                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-10 h-16">Profile</TableHead>
                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-slate-400 h-16">Business Information</TableHead>
                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-slate-400 h-16">Status</TableHead>
                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-slate-400 h-16">Joined</TableHead>
                            <TableHead className="text-right text-[10px] font-black uppercase tracking-widest text-slate-400 pr-10 h-16">Actions</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {isLoading ? (
                            ...
                            >
                                <TableCell className="py-6 pl-10">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-bold text-slate-900 text-sm whitespace-nowrap">{user.name}</p>
