        ...
        <div className="flex h-screen bg-[#F8FAFC] overflow-hidden">
                ...
                <nav className="flex-1 px-4 py-8 space-y-2">
                    {ADMIN_NAV.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <Link href={item.href}>
                                    <Icon className={cn("h-5 w-5 mr-3 transition-transform group-hover:scale-110", isActive ? "text-primary" : "text-slate-400")} />
            ...
            <main className="flex-1 overflow-y-auto relative custom-scrollbar">
                ...
                <header className="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-10 h-20 flex items-center justify-between z-40">
                    <h2 className="text-sm font-bold text-slate-400 uppercase tracking-[0.2em]">Platform Control Center</h2>
