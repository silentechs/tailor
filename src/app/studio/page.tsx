...
import { ArrowUpRight, Clock, Layers, Ruler, ShoppingBag, Star, TriangleAlert } from 'lucide-react';
  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      <section className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        ...
        >
          Your personal portal for bespoke tracking, measurements, and a dedicated style hub.
          Powered by StitchCraft Ghana.
        </motion.div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 md:auto-rows-[160px]">
        ...
        >
          ...
          <div>
            ...
            <h2 className="text-4xl font-black font-heading uppercase mb-2">
              Active <br /> Orders
            </h2>
          ...
          <Link
            href="/studio/orders"
            className="flex items-center gap-2 text-ghana-gold font-black group-hover:gap-4 transition-all"
          >
        ...
        >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-white/5 pb-2">
                ...
                <span className="font-bold text-sm">
                  {data.summary.lastMeasurement
                    ? new Date(data.summary.lastMeasurement).toLocaleDateString()
                    : 'Never'}
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <Badge
                  variant="outline"
                  className="text-emerald-500 border-emerald-500/30 bg-emerald-500/5 rounded-full px-3"
                >
                  Verified
                </Badge>
              </div>
          ...
          <Link
            ...
            className="mt-6 flex items-center gap-2 text-zinc-300 font-bold uppercase text-xs hover:text-white transition-colors"
          >
        ...
        >
          <div>
            ...
            <h3 className="text-5xl font-black font-heading leading-none uppercase mb-4">
              Style <br /> Curator
            </h3>
          ...
          <Button
            className="w-full bg-ghana-black text-white rounded-2xl h-14 font-black uppercase tracking-widest text-xs"
            asChild
          >
        ...
        <div className="md:col-span-4 lg:col-span-4 md:row-span-1 bg-white/5 rounded-[2rem] border border-white/5 flex items-center justify-between px-8 py-4 group hover:bg-white/10 transition-colors">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <h4 className="font-bold">{data.orders[0]?.garmentType || 'No recent orders'}</h4>
            </div>
          </div>
          {data.orders[0] && (
      ...
      <section className="pt-20 border-t border-white/5 grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div>
          <h3 className="text-sm font-black uppercase tracking-[0.4em] text-zinc-600 mb-8 underline decoration-ghana-gold/50 underline-offset-8">
            The Philosophy
          </h3>
          <p className="text-2xl font-heading leading-relaxed font-bold italic text-zinc-300">
            "Fashion is not just what you wear, it's how you tell your story through every stitch,
            measurement, and curve."
          </p>
        </div>
        <div className="flex justify-center items-center">
          <div className="relative group cursor-none">
            ...
            <div className="mt-8 text-center">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-ghana-gold">
                Authentic StitchCraft
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          size="lg"
          className="rounded-2xl h-16 px-12 text-lg font-black bg-ghana-gold text-ghana-black hover:bg-ghana-gold/90"
        >
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            className="bg-ghana-gold text-ghana-black rounded-xl"
          >
