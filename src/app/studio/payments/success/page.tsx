    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                ...
                <Button onClick={() => router.push('/studio/orders')} className="rounded-2xl">Return to Orders</Button>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
            ...
            >
                ...
                >
                    Back to My Orders <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
            </motion.div>
        </div>
    );
