    ...
    return (
        <div className="space-y-12 pb-20">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                <div>
                    <span className="text-secondary font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Precision Control</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            {!latest && (
                                <div className="py-20 text-center">
                                    ...
                                    <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">No measurements found for your profile</p>
                                </div>
                            )}
                        </div>
                    </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="bg-ghana-gold text-ghana-black border-none rounded-[2.5rem] p-4">
                            <CardHeader>
                                <CardTitle className="text-xl font-black font-heading uppercase">Tailor Notes</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-ghana-black/70 font-bold leading-relaxed italic">
                                    {latest?.notes || "No special tailoring notes at this time. Your profile is optimized for standard formal cuts."}
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-zinc-900 border-white/5 rounded-[2.5rem] p-4">
                            <CardHeader>
                                <CardTitle className="text-xl font-black font-heading uppercase text-white">Advice</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-zinc-500 font-bold leading-relaxed">
                                    Based on your shoulder-to-chest ratio, we recommend **Structured Shoulders** for all blazers and coats.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                ...
                <div className="space-y-8">
                    <section className="bg-zinc-900/50 border border-white/5 rounded-[2.5rem] p-8">
                        ...
                        <div className="space-y-6">
                            {history?.map((h: any, idx: number) => (
                                <div key={h.id} className="group relative pl-6 border-l border-white/10 pb-6 last:pb-0">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="font-bold text-sm tracking-tight italic">Fitting Session #{history.length - idx}</span>
                    ...
                    <section className="bg-ghana-black border border-white/10 rounded-[2.5rem] p-8 overflow-hidden relative group">
                        ...
                        <h3 className="text-xl font-black font-heading uppercase mb-4 text-white">Validation</h3>
