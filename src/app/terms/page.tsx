          ...
          <div className="space-y-12">
            ...
            <article className="prose prose-slate prose-lg max-w-none text-slate-600 leading-relaxed font-medium">
              ...
              <p>
                ...
                orders, measurements, or financial records created under your account are your legal
                responsibility.
              </p>

              <h2 className="text-2xl font-bold text-slate-900 font-heading pt-8">3. Fair Usage</h2>
              <p>
                The platform is designed for legitimate business use. Spamming, scraping, or
                attempting to compromise the "Measurement Engine" is strictly prohibited and will
                result in immediate suspension by Silentech.
              </p>
              ...
              <p>
                StitchCraft may charge transaction fees or subscription costs for advanced workshop
                tools. All fees are non-refundable unless otherwise specified in accordance with
                Ghanaian consumer protection laws.
              </p>
