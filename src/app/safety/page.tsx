          ...
          <div className="space-y-12">
            <header className="space-y-4">
              <h1 className="text-5xl md:text-6xl font-black font-heading text-slate-900 tracking-tight">
                Platform <span className="text-primary italic">Safety</span>
              </h1>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-sm">
                Building Trust in Ghanaian Fashion
              </p>
            </header>
            ...
            <div className="prose prose-slate prose-lg max-w-none text-slate-600 leading-relaxed font-medium">
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose mt-12">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col gap-4">
                  ...
                  <p className="text-slate-600 text-sm">
                    Your client measurements and proprietary designs are your intellectual property.
                    They are stored in encrypted databases and are never shared without your
                    explicit permission.
                  </p>
                </div>
              </div>
              ...
              <ul className="list-disc pl-6 space-y-2 marker:text-primary">
                <li>
                  <strong>Meet in Professional Spaces:</strong> Conduct fittings in your registered
                  workshop or a public location whenever possible.
                </li>
                <li>
                  <strong>Clear Communication:</strong> confirm appointment details through the
                  Client Portal to maintain a digital record of interactions.
                </li>
                <li>
              ...
              <p>
                If you encounter any suspicious behavior, fake accounts, or payment irregularities,
                please report them immediately.
              </p>
              <p>
                Email our Trust & Safety team:{' '}
                <strong className="text-primary">support@silentech.live</strong>
              </p>
            </div>
          </div>
        </div>
